...
| TS_DB_MYSQL_HOST         | mysql                      | The hostname or IP addresss of your MySQL server.                                                                                                                                                                                                                                                   |
| TS_DB_MYSQL_PORT         | 3306                       | The TCP port of your MySQL server.                                                                                                                                                                                                                                                                  |
| TS_DB_MYSQL_USERNAME     | root                       | The username used to authenticate with your MySQL server.                                                                                                                                                                                                                                           |
